...
In the SDK subfolder [`samples/`](https://github.com/hardwario/chester-sdk/tree/main/samples), you find many samples explaining working with different sensors and subsystems. Each sample is a separate project, which you can compile and flash to CHESTER.
...
| chester_x0_adc    | [**CHESTER-X0**](../extension-modules/chester-x0.md) (4-ch input/output) + `ctr_adc`                         |
| chester_x10       | [**CHESTER-X10**](../extension-modules/chester-x10.md) (Li-Po charger)                                       |
...
| chester_x9        | [**CHESTER-X7**](../extension-modules/chester-x9.md) (4-ch output)                                           |
...
| ctr_cloud         | CHESTER Cloud                                                                                                |
| ctr_edge          | Pin interrupts                                                                                               |
| ctr_edge_gpio     | Pin interrupts                                                                                               |
...
| mb7066            | Reading distance data using the Maxbotix MB7066 sensor                                                       |
